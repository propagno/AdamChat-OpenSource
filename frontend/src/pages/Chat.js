...
const Chat = () => {
  ...
  const [userChats, setUserChats] = useState([
    { id: 1, title: "Consulta sobre diabetes", date: "2023-07-15", active: true },
    { id: 2, title: "Discussão sobre hipertensão", date: "2023-07-14" },
    { id: 3, title: "Dúvidas sobre medicamentos", date: "2023-07-10" }
  ]);
